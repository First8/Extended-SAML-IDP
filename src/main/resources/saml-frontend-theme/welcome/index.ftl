...
${errorMessage}
            ...
            <#else>
                <p class="welcome-message">
                    <img src="welcome-content/alert.png">You need local access to create the initial admin user. <br><br>Open <a href="${localAdminUrl}">
${localAdminUrl}
</a>
                    <br>
        ...
        <div class="col-xs-12 col-sm-4">
          ...
          <div class="col-xs-12 col-sm-4">
              <div class="card-pf h-m">
                  <h3><a href=${adminUrl?keep_before_last('admin/')}realms/master/samlconfig/pages/realm  target="_blank">
